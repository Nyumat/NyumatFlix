...
export declare function streamResolutionRank(
  name: string,
  resolution?: string,
): number;
...
export declare function compareStreamRank(
  a: StreamRankInput,
  b: StreamRankInput,
): number;
export declare function rankStreams<T extends StreamRankInput>(
  streams: readonly T[],
): T[];
export declare function pickBestStream<T extends StreamRankInput>(
  streams: readonly T[],
): T | null;
