...
const FAQList: FAQProps[] = [
  {
    ...
    answer:
      "We do not host any content through on-prem servers. We only provide links to third-party APIs such as 2embed, etc. These third parties often inject scripts into their iframes (the elements that play the movies/tv shows) - to display ads. We recommend using an adblocker to block these ads - as Nyumatflix itself is ad-free!",
    value: "item-0",
  },
  {
    question: "Where is the source code for this website?",
    answer:
      "The source code for this website is available on GitHub (https://github.com/Nyumat/NyumatFlix). Feel free to submit a pull request with any improvements you think are needed!",
    value: "item-3",
  },
  {
