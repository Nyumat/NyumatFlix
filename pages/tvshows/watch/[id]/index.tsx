...
const WatchTvPage = ({ tvshow, actors, url }: TVPlayerProps) => {
  ...
  return (
    <>
      <Head>
        <title>{tvshow.name} | NyumatFlix</title>
        <meta
          name="description"
          content={`Watch ${tvshow.name} on NyumatFlix`}
        />
        <meta
          property="og:title"
          content={`${tvshow.name} | NyumatFlix`}
          key="ogtitle"
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://nyumatflix.vercel.app/tvshows/watch/${ts_id}`}
          key="ogurl"
        />
      </Head>
      <PageTransition>
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="w-full h-full my-10 z-10">
              ...
              <p className="text-white font-bold text-md tracking-wide my-12 max-w-sm italic mx-auto text-center">
                Note: The episode selector is on the top left of the video
                player.
              </p>
